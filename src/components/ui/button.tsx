...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-95",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-md rounded-full",
        destructive: "bg-destructive text-destructive-foreground hover:bg-destructive/90 shadow-md rounded-full",
        outline: "border-2 border-input bg-card hover:bg-muted rounded-full",
        secondary: "bg-secondary text-secondary-foreground hover:bg-secondary/80 shadow-md rounded-full",
        ghost: "hover:bg-accent/10 hover:text-accent rounded-md",
        link: "text-primary underline-offset-4 hover:underline",
        circular: "rounded-full w-16 h-16 bg-primary text-primary-foreground hover:bg-primary/90 shadow-lg hover:shadow-xl",
        circularRed: "rounded-full w-16 h-16 bg-destructive text-destructive-foreground hover:bg-destructive/90 shadow-lg hover:shadow-xl",
      },
      size: {
